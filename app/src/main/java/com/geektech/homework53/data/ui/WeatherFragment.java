...
public class WeatherFragment extends BaseFragment<FragmentWeatherBinding> implements OnItemClick<Integer> {
    ...
    private WeathViewModel weathViewModel;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        weathViewModel = new ViewModelProvider(requireActivity()).get(WeathViewModel.class);
        cityName = "Bishkek";
        try {
        ...
        weathViewModel.getWeatherByCityName(args.getCity());
    }
...
//            args = WeatherFragmentArgs.fromBundle(getArguments());
        ...
        weathViewModel.getWeatherByCityName(cityName);
    }
    ...
    protected void setupObservers() {
        weathViewModel.liveData.observe(getViewLifecycleOwner(), new Observer<Resource<WeatherApp>>() {
            @Override
